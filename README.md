...
**Alumno:** Jesus Maximiliano Peña Reatiga  
**Numero de Control:** 18170421
---

## Índice:

U1. **Árbol Binario de Búsqueda (Diagnóstico)**
   - [Notebook](./1/ArbolBinario.ipynb)
   - [Script Python](./1/ArbolBinario.py)

U2. **Historia de la IA**
   - [Documento PDF](./2/FloresSotoGael-ResumenHistoriaIA.pdf)

U3. **Algoritmo de Dijkstra (Investigación / Ejercicio)**
